*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_CVIV_CUST_TO_BP2
*   generation date: 23.06.2005 at 21:24:35 by user C5028874
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_CVIV_CUST_TO_BP2    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_CVIV_CUST_TO_BP2'
         EXPORTING
              FCODE          = READ
...
EXTRACT = CVIV_CUST_TO_BP2_EXTRACT
TOTAL = CVIV_CUST_TO_BP2_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_CVIV_CUST_TO_BP2'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_CVIV_CUST_TO_BP2-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = CVIV_CUST_TO_BP2_EXTRACT
TOTAL = CVIV_CUST_TO_BP2_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_CVIV_CUST_TO_BP2-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_CVIV_CUST_TO_BP2'
...
TOTAL = CVIV_CUST_TO_BP2_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_CVIV_CUST_TO_BP2-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_CVIV_CUST_TO_BP2-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_CVIV_CUST_TO_BP2'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_CVIV_CUST_TO_BP2-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = CVIV_CUST_TO_BP2_EXTRACT
TOTAL = CVIV_CUST_TO_BP2_TOTAL
