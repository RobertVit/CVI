...
* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 7.37 on 26.11.2019 with option ALL

* The individual coding starts at 'FORM update_01.' ( line 4.668 )
...
FORM update_01. " REPT PRECHECK_UPGRADATION_REPORT ( EN , source: E18 )
  CALL METHOD lcl_wb=>create_program_text    "#EC *
    EXPORTING
      i_progname   = 'PRECHECK_UPGRADATION_REPORT'
      i_devclass   = 'CVI_MAPPING'
      i_masterlang = 'E'
      i_langu      = 'E':
      i_id         = 'I'
      i_key        = '001'
      i_text       = 'Customer Value Mapping Not Maintained'  "#EC NOTEXT
      i_length     = '74',

      i_id         = 'I'
      i_key        = '002'
      i_text       = 'BP Roles Not Assigned to Account Groups'  "#EC NOTEXT
      i_length     = '86',

      i_id         = 'I'
      i_key        = '003'
      i_text       = 'BP Grouping Not Available for Account Groups'  "#EC NOTEXT
      i_length     = '94',

      i_id         = 'I'
      i_key        = '004'
      i_text       = 'CVI Mapping Not Maintained'  "#EC NOTEXT
      i_length     = '52',

      i_id         = 'I'
      i_key        = '005'
      i_text       = 'Vendor Value Mapping not maintained'  "#EC NOTEXT
      i_length     = '70',

      i_id         = 'I'
      i_key        = '006'
      i_text       = 'Industry not maintained in table TP038M1 in client kindly refer note 2210486'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '007'
      i_text       = 'Contact Person Mapping Not Maintained'  "#EC NOTEXT
      i_length     = '74',

      i_id         = 'I'
      i_key        = '008'
      i_text       = 'Customer/Vendor Value Mapping Not Maintained (BP->Customer/Vendor)'  "#EC NOTEXT
      i_length     = '132',
      ...
      i_id         = 'I'
      i_key        = '010'
      i_text       = 'Contact person mapping - Customer'  "#EC NOTEXT
      i_length     = '44',

      i_id         = 'I'
      i_key        = '011'
      i_text       = 'Error Messages'  "#EC NOTEXT
      i_length     = '24',
      ...
      i_id         = 'I'
      i_key        = '013'
      i_text       = 'Value mapping (BP -> Customer/Vendor)'  "#EC NOTEXT
      i_length     = '114',

      i_id         = 'I'
      i_key        = '014'
      i_text       = 'Error Type'  "#EC NOTEXT
      i_length     = '20',

      i_id         = 'I'
      i_key        = '015'
      i_text       = 'Vendor value mapping'  "#EC NOTEXT
      i_length     = '40',

      i_id         = 'I'
      i_key        = '016'
      i_text       = 'Precheck Details'  "#EC NOTEXT
      i_length     = '26',
      ...
      i_id         = 'I'
      i_key        = '018'
      i_text       = 'Kindly refer to SAP Note 2210486.'  "#EC NOTEXT
      i_length     = '50',

      i_id         = 'I'
      i_key        = '019'
      i_text       = 'is not having CVI mapping check the table CVI_CUST_LINK.'  "#EC NOTEXT
      i_length     = '100',
      ...
      i_id         = 'I'
      i_key        = '021'
      i_text       = 'Vendor account group is not maintained in table CVIC_VEND_TO_BP1.'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '022'
      i_text       = 'Customer account group is not maintained in table CVIC_CUST_TO_BP1.'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '023'
      i_text       = 'Vendor Account Group is not maintained in table CVIC_VEND_TO_BP2.'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '024'
      i_text       = 'is not having CVI mapping check the table CVI_VEND_LINK.'  "#EC NOTEXT
      i_length     = '72',

      i_id         = 'I'
      i_key        = '025'
      i_text       = 'Contact person assignment not activated and not maintained in table CVIC_MAP_CONTACT.'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '026'
      i_text       = 'Department not maintained in table CVIC_CP1_LINK.'  "#EC NOTEXT
      i_length     = '116',

      i_id         = 'I'
      i_key        = '027'
      i_text       = 'Function not maintained in table CVIC_CP2_LINK.'  "#EC NOTEXT
      i_length     = '112',

      i_id         = 'I'
      i_key        = '028'
      i_text       = 'Authority not mainatined in table CVIC_CP3_LINK.'  "#EC NOTEXT
      i_length     = '114',

      i_id         = 'I'
      i_key        = '029'
      i_text       = 'VIP Indicator not mainatined in table CVIC_CP4_LINK.'  "#EC NOTEXT
      i_length     = '122',
      ...
      i_id         = 'I'
      i_key        = '031'
      i_text       = 'Marital Status not mainatined in table CVIC_MARST_LINK.'  "#EC NOTEXT
      i_length     = '128',

      i_id         = 'I'
      i_key        = '032'
      i_text       = 'Legal form not maintained in table CVIC_LEGFORM_LNK.'  "#EC NOTEXT
      i_length     = '122',

      i_id         = 'I'
      i_key        = '033'
      i_text       = 'Payment Card not maintained in table CVIC_CCID_LINK.'  "#EC NOTEXT
      i_length     = '122',

      i_id         = 'I'
      i_key        = '034'
      i_text       = 'Industry not maintained in table TP038M2.'  "#EC NOTEXT
      i_length     = '100',

      i_id         = 'I'
      i_key        = '035'
      i_text       = 'Industry not maintained in table TP038M1.'  "#EC NOTEXT
      i_length     = '100',
      ...
      i_id         = 'I'
      i_key        = '038'
      i_text       = 'Contact person is not maintanined in table CVI_CUST_CT_LINK.'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '039'
      i_text       = 'Contact person is not maintained in table CVI_VEND_CT_LINK.'  "#EC NOTEXT
      i_length     = '132',
      ...
      i_id         = 'I'
      i_key        = '042'
      i_text       = 'Some of the customer or vendor account groups are not maintained kindly refer note 2210486'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '043'
      i_text       = 'Some of the customer or vendor account groups are not assigned to any roles  kindly refer note 2210486'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '044'
      i_text       = 'Some of the customer or vendor numbers are not mapped kindly refer note 2210486'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '045'
      i_text       = 'Some of the customer value mapping is not maintained kindly refer note 2210486'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '046'
      i_text       = 'Some of the vendor value mapping is not maintained kindly refer note 2210486'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '047'
      i_text       = 'Some of the customers are not having contact person mapping kindly refer note 2210486'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '048'
      i_text       = 'Some of the post value mapping for customer and vendor are not maintained kindly refer note 2210486'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '049'
      i_text       = 'Synchronization direction (BP->Customer/Vendor) is not active'  "#EC NOTEXT
      i_length     = '80',

      i_id         = 'I'
      i_key        = '050'
      i_text       = 'Synchronization direction (BP->Customer/Vendor) is active'  "#EC NOTEXT
      i_length     = '80',

      i_id         = 'I'
      i_key        = '051'
      i_text       = 'Customizing Error'  "#EC NOTEXT
      i_length     = '27',

      i_id         = 'I'
      i_key        = '052'
      i_text       = 'Data Error'  "#EC NOTEXT
      i_length     = '20',

      i_id         = 'I'
      i_key        = '053'
      i_text       = 'Pre-upgrade Checks'  "#EC NOTEXT
      i_length     = '28',

      i_id         = 'I'
      i_key        = '054'
      i_text       = 'CVI link mapping'  "#EC NOTEXT
      i_length     = '21',
      ...
      i_id         = 'I'
      i_key        = '056'
      i_text       = 'Value mapping (Customer/Vendor -> BP)'  "#EC NOTEXT
      i_length     = '44',

      i_id         = 'I'
      i_key        = '057'
      i_text       = 'Account group assigned to BP grouping'  "#EC NOTEXT
      i_length     = '98',

      i_id         = 'I'
      i_key        = '058'
      i_text       = 'BP roles assigned to account groups'  "#EC NOTEXT
      i_length     = '78',

      i_id         = 'I'
      i_key        = '059'
      i_text       = 'Mandatory checks cannot be unchecked'  "#EC NOTEXT
      i_length     = '72',
      ...
      i_id         = 'I'
      i_key        = '061'
      i_text       = 'Check Name'  "#EC NOTEXT
      i_length     = '20',

      i_id         = 'I'
      i_key        = '062'
      i_text       = 'Customer Account Group is not maintained in table CVIC_CUST_TO_BP2.'  "#EC NOTEXT
      i_length     = '132',

      i_id         = 'I'
      i_key        = '063'
      i_text       = 'Precheck Status Result'  "#EC NOTEXT
      i_length     = '44',

      i_id         = 'I'
      i_key        = '064'
      i_text       = 'CVI link - Customer (&1/&2)'  "#EC NOTEXT
      i_length     = '51',

      i_id         = 'I'
      i_key        = '065'
      i_text       = 'No Error'  "#EC NOTEXT
      i_length     = '18',
      ...
      i_id         = 'I'
      i_key        = '067'
      i_text       = 'Display results for'  "#EC NOTEXT
      i_length     = '29',

      i_id         = 'I'
      i_key        = '068'
      i_text       = 'CVI link - Vendor (&1/&2)'  "#EC NOTEXT
      i_length     = '58',

      i_id         = 'I'
      i_key        = '069'
      i_text       = 'Contact person mapping - Vendor'  "#EC NOTEXT
      i_length     = '62',

      i_id         = 'I'
      i_key        = '070'
      i_text       = 'Contact person mapping'  "#EC NOTEXT
      i_length     = '44',

      i_id         = 'I'
      i_key        = '071'
      i_text       = 'BP role assigned to customer account group'  "#EC NOTEXT
      i_length     = '98',

      i_id         = 'I'
      i_key        = '072'
      i_text       = 'BP role assigned to vendor account group'  "#EC NOTEXT
      i_length     = '94',

      i_id         = 'I'
      i_key        = '073'
      i_text       = 'Customer account group assigned to BP role'  "#EC NOTEXT
      i_length     = '84',

      i_id         = 'I'
      i_key        = '074'
      i_text       = 'Vendor account group assigned to BP role'  "#EC NOTEXT
      i_length     = '80',

      i_id         = 'I'
      i_key        = '075'
      i_text       = 'Choose either Customer or Vendor to execute'  "#EC NOTEXT
      i_length     = '86',

      i_id         = 'R'
      i_key        = ''
      i_text       = 'Report PRECHECK_UPGRADATION_REPORT'  "#EC NOTEXT
      i_length     = '34'.

ENDFORM.

FORM update_02. " CUAD PRECHECK_UPGRADATION_REPORT ( EN , source: E18 )
 DATA:  ls_adm TYPE rsmpe_adm,
  ...
  CLEAR ls_sta.
  ls_sta-code                    = 'PF_STATUS'.
  ls_sta-modal                   = 'D'.
  ls_sta-actcode                 = '000001'.
  ls_sta-pfkcode                 = '000001'.
  ls_sta-butcode                 = '0001'.
  ls_sta-int_note                = 'PF Status'. "#EC NOTEXT "#EC TRANSLANG
  APPEND ls_sta TO lt_sta.

  CLEAR ls_sta.
  ls_sta-code                    = 'STATUS_0201'.
  ls_sta-modal                   = 'D'.
  ...
  CLEAR ls_sta.
  ls_sta-code                    = 'STATUS_200'.
  ls_sta-modal                   = 'D'.
  ls_sta-actcode                 = '000003'.
  ls_sta-pfkcode                 = '000004'.
  ls_sta-butcode                 = '0001'.
  ls_sta-int_note                = 'PF Status'. "#EC NOTEXT "#EC TRANSLANG
  APPEND ls_sta TO lt_sta.
  ...
  ls_fun-icon_id                 = '@0V@'.
  ls_fun-fun_text                = 'Ok'. "#EC NOTEXT "#EC TRANSLANG
  APPEND ls_fun TO lt_fun.
  ...
  CLEAR ls_tit.
  ls_tit-code                    = 'TITL_0201'.
  ls_tit-text                    = '&'.
  APPEND ls_tit TO lt_tit.

  CLEAR ls_tit.
  ls_tit-code                    = 'TITL_200'.
  ls_tit-text                    = 'Precheck Upgrade Result'. "#EC NOTEXT "#EC TRANSLANG
  APPEND ls_tit TO lt_tit.

  CLEAR ls_tit.
  ls_tit-code                    = 'TIT_STAT'.
  ls_tit-text                    = 'Precheck Upgrade Report'. "#EC NOTEXT "#EC TRANSLANG
  APPEND ls_tit TO lt_tit.
...
FORM update_03. " DOCU REPRECHECK_UPGRADATION_REPORT ( EN , source: E18 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'CVI_MAPPING'
      i_docname   = 'REPRECHECK_UPGRADATION_REPORT'
      i_langu     = 'E'
      i_line      =:'U1 &PURPOSE&',                                                                                "#EC NOTEXT
                    'AS This report performs the necessary checks for Business Partner before',                    "#EC NOTEXT
                    '   upgrading to S/4HANA.',                                                                    "#EC NOTEXT
                    'AS The <ZH>prechecks </>that the report executes are listed here:',                           "#EC NOTEXT
                    'B1 <LS>BP roles are assigned to account groups</>',                                           "#EC NOTEXT
                    'B1 <LS>Every account group BP Grouping must be available</>',                                 "#EC NOTEXT
                    'B1 <LS>Customer Value Mapping</>',                                                            "#EC NOTEXT
                    'B1 <LS>Vendor Value Mapping</>',                                                              "#EC NOTEXT
                    'B1 <LS>Customer and Vendor Value Mapping (BP-> Customer or Vendor)</>',                       "#EC NOTEXT
                    'B1 <LS>CVI_Link</>',                                                                          "#EC NOTEXT
                    'B1 <LS>CVI Mapping</>',                                                                       "#EC NOTEXT
                    'B1 <LS>Contact Person Mapping</>',                                                            "#EC NOTEXT
                    'AS Note that <LS>CVI Mapping</> and <LS>Contact Person Mapping</> are',                       "#EC NOTEXT
                    '   mandatory checks that you need to perform.',                                               "#EC NOTEXT
                    'AS The report also performs a <ZH>post check</>, <LS>Contact Person',                         "#EC NOTEXT
                    '   Attributes</>.',                                                                           "#EC NOTEXT
                    'U1 &INTEGRATION&',                                                                            "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'U1 &PREREQUISITES&',                                                                          "#EC NOTEXT
                    'AS Before you execute the report, ensure that you maintain the Customizing',                  "#EC NOTEXT
                    '   entries listed below for the checks that you want the report to perform:',                 "#EC NOTEXT
                    'AS <ZH>PRECHECKS</>',                                                                         "#EC NOTEXT
                    'B1 <ZH>BP roles are assigned to account groups </>',                                          "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'AL For <ZH>Customer</>, you must maintain the entries in Customizing for',                    "#EC NOTEXT
                    '   <ZH>Business Partner </>under <LS>Cross-Application Components</> ->',                     "#EC NOTEXT
                    '   <LS>Master Data Synchronization</> -> <LS>Customer/Vendor Integration',                    "#EC NOTEXT
                    '   </>-> <LS>Business Partner Settings </>-> <LS>Settings for Customer',                      "#EC NOTEXT
                    '   Integration </>->',                                                                        "#EC NOTEXT
                    '=   <DS:SIMG.CVIV_CUST_TO_BP2>Define BP Role  for Direction Customer to BP',                  "#EC NOTEXT
                    '=  </>',                                                                                      "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'AL For <ZH>Vendor</>, you must maintain the entries in Customizing for',                      "#EC NOTEXT
                    '   <ZH>Business Partner </>under <LS>Cross-Application Components</> ->',                     "#EC NOTEXT
                    '   <LS>Master Data Synchronization</> -> <LS>Customer/Vendor Integration',                    "#EC NOTEXT
                    '   </>-> <LS>Business Partner Settings </>-> <LS>Settings for Vendor',                        "#EC NOTEXT
                    '   Integration </>->',                                                                        "#EC NOTEXT
                    '=   <DS:SIMG.CVIV_VEND_TO_BP2>Define BP Role for Direction Vendor to BP</>',                  "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'B1 <ZH>For every account group BP Grouping must be available</>',                             "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'AL For <ZH>Customer</>, you must maintain the entries in Customizing for',                    "#EC NOTEXT
                    '   <ZH>Business Partner </>under <LS>Cross-Application Components</> -><LS>',                 "#EC NOTEXT
                    '   Master Data Synchronization</> -> <LS>Customer/Vendor Integration </>->',                  "#EC NOTEXT
                    '   <LS>Business Partner Settings </>-> <LS>Settings for Customer',                            "#EC NOTEXT
                    '   Integration </>-> <LS>Field Assignment for Customer Integration</> ->',                    "#EC NOTEXT
                    '   <LS>Assign Keys</> ->',                                                                    "#EC NOTEXT
                    '=   <DS:SIMG.CVIV_CUST_TO_BP1>Define Number Assignment for Direction',                        "#EC NOTEXT
                    '   Customer to BP</>',                                                                        "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'AL For <ZH>Vendor</>, you must maintain the entries in Customizing for',                      "#EC NOTEXT
                    '   <ZH>Business Partner </>under <LS>Cross-Application Components</> ->',                     "#EC NOTEXT
                    '   <LS>Master Data Synchronization</> -> <LS>Customer/Vendor Integration',                    "#EC NOTEXT
                    '   </>-> <LS>Business Partner Settings </>-> <LS>Settings for Vendor',                        "#EC NOTEXT
                    '   Integration </>-> <LS>Field Assignment for Vendor Integration </>->',                      "#EC NOTEXT
                    '   <LS>Assign Keys</> ->',                                                                    "#EC NOTEXT
                    '=   <DS:SIMG.CVIV_VEND_TO_BP1>Define Number Assignment for Direction Vendor',                 "#EC NOTEXT
                    '   to BP</>',                                                                                 "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'B1 <ZH>For Customer Value Mapping</>',                                                        "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'AL You must maintain the entries in Customizing for <ZH>Business Partner',                    "#EC NOTEXT
                    '   </>under <LS>Cross-Application Components</> -> <LS>Master Data',                          "#EC NOTEXT
                    '   Synchronization</> -> <LS>Customer/Vendor Integration </>-> <LS>Business',                 "#EC NOTEXT
                    '   Partner Settings </>-> <LS>Settings for Customer Integration </>->',                       "#EC NOTEXT
                    '   <LS>Field Assignment for Customer Integration </>-><LS>Assign Attributes',                 "#EC NOTEXT
                    '=  </> -> <LS>Contact Person</> ->',                                                          "#EC NOTEXT
                    'B2 <DS:SIMG.CVI_MAP_CONTACT>Activate Assignment of Contact Persons</>',                       "#EC NOTEXT
                    'B2 <DS:SIMG.CVIV_CP1_LINK>Assign Department Numbers for Contact Person</>',                   "#EC NOTEXT
                    'B2 <DS:SIMG.CVIV_CP2_LINK>Assign Functions of Contact Person</>',                             "#EC NOTEXT
                    'B2 <DS:SIMG.CVIV_CP3_LINK>Assign Authority of Contact Person</>',                             "#EC NOTEXT
                    'B2 <DS:SIMG.CVIV_CP4_LINK>Assign VIP Indicator for Contact Person</>',                        "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'AL You must maintain the entries in Customizing for <ZH>Business Partner',                    "#EC NOTEXT
                    '   </>under <LS>Cross-Application Components</> -> <LS>Master Data',                          "#EC NOTEXT
                    '   Synchronization</> -> <LS>Customer/Vendor Integration </>-> <LS>Business',                 "#EC NOTEXT
                    ...
                    '   <LS>Field Assignment for Customer Integration </>-><LS>Assign Attributes',                 "#EC NOTEXT
                    '   </>->',                                                                                    "#EC NOTEXT
                    'B2 <DS:SIMG.CVIV_MARST_LINK>Assign Marital Statuses</>',                                      "#EC NOTEXT
                    'B2 <DS:SIMG.CVIV_LEGFORM_LNK>Assign Legal Form to Legal Status</>',                           "#EC NOTEXT
                    'B2 <DS:SIMG.CVIC_CCID_LINK>Assign Payment Cards</>',                                          "#EC NOTEXT
                    'B2 <DS:SIMG.VC_TP038M>Assign Industries</>',                                                  "#EC NOTEXT
                    'B1 <ZH>For Vendor Value Mapping</>',                                                          "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'AL You must maintain the entries in Customizing for <ZH>Business Partner',                    "#EC NOTEXT
                    '   </>under <LS>Cross-Application Components</> -> <LS>Master Data',                          "#EC NOTEXT
                    '   Synchronization</> -> <LS>Customer/Vendor Integration </>-> <LS>Business',                 "#EC NOTEXT
                    '   Partner Settings </>-> <LS>Settings for Customer Integration </>->',                       "#EC NOTEXT
                    '   <LS>Field Assignment for Vendor Integration </>-><LS>Assign Attributes',                   "#EC NOTEXT
                    '=  </> -> <LS>Assign Industries</>',                                                          "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'B1 <ZH>For Checking Direction from Customer to BP</>',                                        "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'AL You must maintain the entries in Customizing for <ZH>Business Partner',                    "#EC NOTEXT
                    '   </>under <LS>Cross-Application Components</> -> <LS>Master Data',                          "#EC NOTEXT
                    '   Synchronization</> -> <LS>Customer/Vendor Integration </>-> <LS>Business',                 "#EC NOTEXT
                    ...
                    '=  </>',                                                                                      "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'B1 <ZH>For Checking Direction from Vendor to BP</>',                                          "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'AL You must maintain the entries in Customizing for <ZH>Business Partner',                    "#EC NOTEXT
                    '   </>under <LS>Cross-Application Components</> -> <LS>Master Data',                          "#EC NOTEXT
                    '   Synchronization</> -> <LS>Customer/Vendor Integration </>-> <LS>Business',                 "#EC NOTEXT
                    '   Partner Settings </>-> <LS>Settings for Vendor Integration</> ->',                         "#EC NOTEXT
                    '=   <DS:SIMG.CVIV_VEND_TO_BP2>Define BP Role for Direction Vendor to BP</>',                  "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'U2 &NOTE&',                                                                                   "#EC NOTEXT
                    'AM You must <ZH>mandatorily </>maintain the Customizing entries for the',                     "#EC NOTEXT
                    '   following checks.',                                                                        "#EC NOTEXT
                    'B1 <ZH>For CVI Mapping </>',                                                                  "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'AL In transaction <ZH>SE 11</>, ensure that you maintain in mapping tables,',                 "#EC NOTEXT
                    '   <ZH>CVI_CUST_LINK </>and <ZH>CVI_VEND_LINK</>, the same number of',                        "#EC NOTEXT
                    '   entries as in customer table <ZH>KNA1</> and vendor table <ZH>LFA1</>.',                   "#EC NOTEXT
                    'B1 <ZH>For Contact Person Mapping </>',                                                       "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'AL In transaction <ZH>SE 11</>, ensure that you maintain in mapping tables,',                 "#EC NOTEXT
                    '   <ZH>CVI_CUST_CT_LINK</> and <ZH>CVI_VEND_CT_LINK</>, the same number of',                  "#EC NOTEXT
                    '   entries as in contact table <ZH>KNVK </>with the condition <ZH>KNVK',                      "#EC NOTEXT
                    '   </>with where condition <ZH>KUNNR <> SPACE</> and <ZH>KNVK  </>with',                      "#EC NOTEXT
                    '   where condition <ZH>LIFNR <> SPACE</>.',                                                   "#EC NOTEXT
                    'AL',                                                                                          "#EC NOTEXT
                    'AS <ZH>POSTCHECK</>',                                                                         "#EC NOTEXT
                    'B1 You must ensure that the entries that you have maintained in',                             "#EC NOTEXT
                    '=       <DS:SIMG.CVIV_CP1_LINK>Assign Department Numbers for Contact Person',                 "#EC NOTEXT
                    '=  </> are available in Customizing for <ZH>Business Partner </>under',                       "#EC NOTEXT
                    '   <LS>Cross-Application Components</> -> <LS>SAP Business Partner ->',                       "#EC NOTEXT
                    '   Business Partner Relationships -> Contact Person -> </>',                                  "#EC NOTEXT
                    'B2 <DS:SIMG._CABP_GPB_TB910>Define Departments</>',                                           "#EC NOTEXT
                    'B2 <DS:SIMG._CABP_GPB_TB912>Define Functions</>',                                             "#EC NOTEXT
                    'B2 <DS:SIMG._CABP_GPB_TB914>Define Powers of Attorney</>',                                    "#EC NOTEXT
                    'B2 <DS:SIMG._CABP_GPB_TB916>Define VIP Entries</>',                                           "#EC NOTEXT
                    'B1 You must ensure that the entries that you have maintained in',                             "#EC NOTEXT
                    '=       <DS:SIMG.CVIV_MARST_LINK>Assign Marital Statuses</> for  are',                        "#EC NOTEXT
                    '   available in Customizing for <ZH>Business Partner </>under <LS>Cr',                        "#EC NOTEXT
                    '=  oss-Application Components</> -> <LS>SAP Business Partner -> Business',                    "#EC NOTEXT
                    '   Partner -> Persons -> Marital Statuses</> ->',                                             "#EC NOTEXT
                    '=   <DS:SIMG._CABP_TB027>Maintain Marital Status</>',                                         "#EC NOTEXT
                    'B1 You must ensure that the entries that you have maintained in',                             "#EC NOTEXT
                    '=       <DS:SIMG.CVIV_LEGFORM_LNK>Assign Legal Form to Legal Status</>  are',                 "#EC NOTEXT
                    '   available in Customizing for <ZH>Business Partner </>under',                               "#EC NOTEXT
                    '   <LS>Cross-Application Components</> -> <LS>SAP Business Partner ->',                       "#EC NOTEXT
                    '   Business Partner -> </>',                                                                  "#EC NOTEXT
                    '=     <DS:SIMG._CABP_TB019></><LS>Maintain Legal Forms</>',                                   "#EC NOTEXT
                    'B1 You must ensure that the entries that you have maintained in',                             "#EC NOTEXT
                    '=       <DS:SIMG.CVIV_LEGFORM_LNK>Assign Legal Form to Legal Status</>  are',                 "#EC NOTEXT
                    '   available in Customizing for <ZH>Business Partner </>under',                               "#EC NOTEXT
                    '   <LS>Cross-Application Components</> -> <LS>SAP Business Partner ->',                       "#EC NOTEXT
                    ...
                    '=     <DS:SIMG._CABP_TB019></><LS>Maintain Legal Forms</>',                                   "#EC NOTEXT
                    'B1 You must ensure that the entries that you have maintained in',                             "#EC NOTEXT
                    '=       <DS:SIMG.CVIC_CCID_LINK>Assign Payment Cards</> are available in',                    "#EC NOTEXT
                    '   Customizing for <ZH>Business Partner </>under <LS>Cross-Application',                      "#EC NOTEXT
                    '   Components</> -> <LS>Payment Cards</> ->',                                                 "#EC NOTEXT
                    '=     <DS:SIMG._CABP_V_TB033_SEC>Maintain Payment Card Type</>',                              "#EC NOTEXT
                    'B1 You must ensure that the entries that you have maintained in',                             "#EC NOTEXT
                    '=   <DS:SIMG.VC_TP038M>Assign Industries</> are available in Customizing',                    "#EC NOTEXT
                    '   for Business Partner-> under <LS>Cross-Application Components</> ->',                      "#EC NOTEXT
                    '   <LS>SAP Business Partner -> Organizations -></>',                                          "#EC NOTEXT
                    ...
                    'AS Based on your requirements, select the checks that you want the report',                   "#EC NOTEXT
                    '   to perform. Then, execute the report.',                                                    "#EC NOTEXT
                    'U2 &STANDARD_VARIANTS&',                                                                      "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'U2 &OUTPUT&',                                                                                 "#EC NOTEXT
                    'AS The report generates an ALV output containing the status of each check',                   "#EC NOTEXT
                    '   that it performs.',                                                                        "#EC NOTEXT
                    'AS If the status is green, this indicates that check is successful.',                         "#EC NOTEXT
                    'AS If the status is red, you must click on the status icon to get more',                      "#EC NOTEXT
                    '   information on what caused the error and resolve the errors by',                           "#EC NOTEXT
                    '   maintaining the Customizing entries listed in <ZH>Prerequisites</>.',                      "#EC NOTEXT
...
FORM update_04. " TRAN CVI_PRECHECK_UPGRADE ( EN , source: E18 )

  CALL METHOD lcl_wb=>create_logical_object "#EC *
    EXPORTING
      i_object     = 'TRAN'
      i_obj_name   = 'CVI_PRECHECK_UPGRADE'
      i_devclass   = 'CVI_MAPPING'
      i_langu      = 'E'
      i_masterlang = 'E'
    EXCEPTIONS
  ...
  CLEAR ls_TSTC.
  ls_tstc-tcode     = 'CVI_PRECHECK_UPGRADE'.                                                       "#EC NOTEXT
  ls_tstc-pgmna     = 'PRECHECK_UPGRADATION_REPORT'.                                                "#EC NOTEXT
  ...
  CLEAR ls_TSTCC.
  ls_tstcc-tcode         = 'CVI_PRECHECK_UPGRADE'.                                                  "#EC NOTEXT
  ...
  ls_tstct-tcode     = 'CVI_PRECHECK_UPGRADE'.                                                      "#EC NOTEXT
  ls_tstct-ttext     = 'Precheck Upgradation Report'.                                               "#EC NOTEXT
...
FORM update.
  ...
  PERFORM update_01. " REPT PRECHECK_UPGRADATION_REPORT ( EN , source: E18 )
  PERFORM update_02. " CUAD PRECHECK_UPGRADATION_REPORT ( EN , source: E18 )
  PERFORM update_03. " DOCU REPRECHECK_UPGRADATION_REPORT ( EN , source: E18 )
  PERFORM update_04. " TRAN CVI_PRECHECK_UPGRADE ( EN , source: E18 )
