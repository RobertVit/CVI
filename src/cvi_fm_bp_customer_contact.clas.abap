class CVI_FM_BP_CUSTOMER_CONTACT definition
  public
  inheriting from CVI_FIELD_MAPPING
  final
  create private .

*"* public components of class CVI_FM_BP_CUSTOMER_CONTACT
*"* do not include other source files here!!!
public section.

  interfaces IF_FSBP_GENERIC_CONSTANTS .

  methods MAP_CC_BUSINESS_ADDRESS
    importing
  ...
  class-methods GET_INSTANCE
    returning
      value(R_INSTANCE) type ref to CVI_FM_BP_CUSTOMER_CONTACT .
  ...
  methods MAP_BP_REL_BUSINESS_ADDRESS
    ...
    changing
      ...
      !C_CONTACT type CMDS_EI_CONTACTS .
protected section.
*"* protected components of class CVI_FM_BP_CUSTOMER_CONTACT
*"* do not include other source files here!!!
private section.
*"* private components of class CVI_FM_BP_CUSTOMER_CONTACT
*"* do not include other source files here!!!
  ...
  class-data INSTANCE type ref to CVI_FM_BP_CUSTOMER_CONTACT .
  ...
  methods MAP_BP_RELATION_ADDRESS
    ...
    changing
      !C_ADDRESS_GUID type SYSUUID_C
      !C_CONTACT type CMDS_EI_CONTACTS .
  methods MAP_CC_CONTACT_ADDRESS
    importing
      !I_CONTACT type CMDS_EI_CONTACTS
    changing
      !C_PARTNER type BUS_EI_EXTERN
      !C_PERSON type BUS_EI_EXTERN        "#EC NEEDED
      !C_RELATION type BURS_EI_EXTERN .
  methods MAP_CC_GENERAL_DATA
    importing
      !I_CONTACT type CMDS_EI_CONTACTS
    changing
      !C_PERSON type BUS_EI_EXTERN
      !C_RELATION type BURS_EI_EXTERN .
  methods MAP_CC_PRIVATE_ADDRESS
    importing
      !I_CONTACT type CMDS_EI_CONTACTS
    changing
      !C_PERSON type BUS_EI_EXTERN .
  methods MAP_CC_BUSINESS_HOURS
    importing
      !I_CONTACT type CMDS_EI_CONTACTS
    changing
      !C_RELATION type BURS_EI_EXTERN .
...
CLASS CVI_FM_BP_CUSTOMER_CONTACT IMPLEMENTATION.
...
method GET_CC_ADDRESS.
  ...
  if ls_errors-is_error = true.
    ...
    read table ls_customer_read-central_data-contact-contacts into ls_contact
      with key data_key-parnr = i_customer_contact_id.
...
method map_bp_address.
  ...
  if sy-subrc = 0.
    if not <address>-task is initial.
      c_contact-address_type_2-task = <address>-task.
    else.
      c_contact-address_type_2-task = task_modify.
    endif.

    move-corresponding:
      <address>-data-postal to c_contact-address_type_2-postal,"#EC ENHOK
      <address>-data-remark to c_contact-address_type_2-remark."#EC ENHOK

    map_bp_version_to_cc(
      exporting
        i_bp_version  = <address>-data-version
      importing
        e_cvi_version = c_contact-address_type_2-version
     ).
    ...
    map_bp_communication(
      ...
      importing
        e_cvi_communication = c_contact-address_type_2-communication
    ).

  else.
    clear c_contact-address_type_2.
  endif.
...
* switching the standard address of the organisation is covered in standard step 6 before
  loop at i_partner-central_data-address-addresses into ls_partner_address
    where data-postal-datax-standardaddress = false.
    ...
    if sy-subrc = 0 and ls_address-data-postal-data-standardaddress = true.
      if c_contact-address_type_1-task is initial.
        c_contact-address_type_1-task = task_update.
      endif.
...
*     relation data was not mapped before -> type 3 attributes can be cleared
      ...
      move-corresponding:
        ls_partner_address-data-postal  to c_contact-address_type_1-postal,
        ls_partner_address-data-remark  to c_contact-address_type_1-remark.  "#EC ENHOK
    endif.
  endloop.
...
method map_bp_general_data.
  ...
  if c_contact-address_type_3-task is initial.
    c_contact-address_type_3-task = task_modify.
  endif.
  move-corresponding i_person-central_data-common-data-bp_person
             to c_contact-address_type_3-postal-data.       "#EC ENHOK
  c_contact-address_type_3-postal-data-birth_name = i_person-central_data-common-data-bp_person-birthname.
  c_contact-address_type_3-postal-data-namctryiso = i_person-central_data-common-data-bp_person-namcountryiso.
  c_contact-address_type_3-postal-data-langu_p    = i_person-central_data-common-data-bp_person-correspondlanguage.
  c_contact-address_type_3-postal-data-langup_iso = i_person-central_data-common-data-bp_person-correspondlanguageiso.
  c_contact-address_type_3-postal-data-fullname_x = i_person-central_data-common-data-bp_person-fullname_man.

  if i_person-central_data-common-data-bp_person-sex = lc_bp_male.
    c_contact-data-parge = lc_contact_male.
    c_contact-address_type_3-postal-data-sex = lc_contact_male.
  elseif i_person-central_data-common-data-bp_person-sex = lc_bp_female.
    c_contact-data-parge = lc_contact_female.
    c_contact-address_type_3-postal-data-sex = lc_contact_female.
  else.
    c_contact-data-parge = i_person-central_data-common-data-bp_person-sex.
    c_contact-address_type_3-postal-data-sex = i_person-central_data-common-data-bp_person-sex.
  endif.
*
  select single famst from cvic_marst_link into c_contact-data-famst
         where  marst      = i_person-central_data-common-data-bp_person-maritalstatus."#EC *

  c_contact-data-gbdat     = i_person-central_data-common-data-bp_person-birthdate.
*  c_contact-data-parla_iso = i_person-central_data-common-data-bp_person-correspondlanguageiso.

  c_contact-address_type_3-postal-data-sort1_p   = i_person-central_data-common-data-bp_centraldata-searchterm1.
  c_contact-address_type_3-postal-data-sort2_p   = i_person-central_data-common-data-bp_centraldata-searchterm2.
  c_contact-address_type_3-postal-data-title_p   = i_person-central_data-common-data-bp_centraldata-title_key.
*  c_contact-address_type_3-postal-data-comm_type = i_person-central_data-common-data-bp_centraldata-comm_type.

  c_contact-data-sortl = i_person-central_data-common-data-bp_centraldata-searchterm1.
*datax
  move-corresponding i_person-central_data-common-datax-bp_person
             to c_contact-address_type_3-postal-datax.      "#EC ENHOK
  c_contact-address_type_3-postal-datax-birth_name = i_person-central_data-common-datax-bp_person-birthname.
  c_contact-address_type_3-postal-datax-namctryiso = i_person-central_data-common-datax-bp_person-namcountryiso.
  c_contact-address_type_3-postal-datax-langu_p    = i_person-central_data-common-datax-bp_person-correspondlanguage.
  c_contact-address_type_3-postal-datax-langup_iso = i_person-central_data-common-datax-bp_person-correspondlanguageiso.
*  c_contact-address_type_3-postal-datax-fullname_x = i_person-central_data-common-datax-bp_person-fullname_man.

  c_contact-datax-parge = i_person-central_data-common-datax-bp_person-sex.

  c_contact-datax-gbdat     = i_person-central_data-common-datax-bp_person-birthdate.
  c_contact-datax-famst     = i_person-central_data-common-datax-bp_person-maritalstatus.
*  c_contact-datax-parla_iso = i_person-central_data-common-datax-bp_person-correspondlanguageiso.

  c_contact-address_type_3-postal-datax-sort1_p   = i_person-central_data-common-datax-bp_centraldata-searchterm1.
  c_contact-address_type_3-postal-datax-sort2_p   = i_person-central_data-common-datax-bp_centraldata-searchterm2.
  c_contact-address_type_3-postal-datax-title_p   = i_person-central_data-common-datax-bp_centraldata-title_key.
*  c_contact-address_type_3-postal-datax-comm_type = i_person-central_data-common-datax-bp_centraldata-comm_type.

  c_contact-datax-sortl = i_person-central_data-common-datax-bp_centraldata-searchterm1.

* type 2 address mapping only if type 2 address is updated
  check c_contact-address_type_2                     is not initial.
*  or
*        i_person-central_data-common-datax-bp_person is not initial.
*  check i_person-central_data-address-addresses is not initial.

  if c_contact-address_type_2-task is initial.
    c_contact-address_type_2-task = task_modify.
  endif.

  move-corresponding i_person-central_data-common-data-bp_person
             to c_contact-address_type_2-postal-data.       "#EC ENHOK
  c_contact-address_type_2-postal-data-birth_name = i_person-central_data-common-data-bp_person-birthname.
  c_contact-address_type_2-postal-data-namctryiso = i_person-central_data-common-data-bp_person-namcountryiso.
  c_contact-address_type_2-postal-data-langu_p    = i_person-central_data-common-data-bp_person-correspondlanguage.
  c_contact-address_type_2-postal-data-langup_iso = i_person-central_data-common-data-bp_person-correspondlanguageiso.
  c_contact-address_type_2-postal-data-fullname_x = i_person-central_data-common-data-bp_person-fullname_man.

  if i_person-central_data-common-data-bp_person-sex = lc_bp_male.
    c_contact-data-parge = lc_contact_male.
    c_contact-address_type_2-postal-data-sex = lc_contact_male.
  elseif i_person-central_data-common-data-bp_person-sex = lc_bp_female.
    c_contact-data-parge = lc_contact_female.
    c_contact-address_type_2-postal-data-sex = lc_contact_female.
  else.
    c_contact-data-parge = i_person-central_data-common-data-bp_person-sex.
    c_contact-address_type_2-postal-data-sex = i_person-central_data-common-data-bp_person-sex.
  endif.

  c_contact-address_type_2-postal-data-sort1_p   = i_person-central_data-common-data-bp_centraldata-searchterm1.
  c_contact-address_type_2-postal-data-sort2_p   = i_person-central_data-common-data-bp_centraldata-searchterm2.
  c_contact-address_type_2-postal-data-title_p   = i_person-central_data-common-data-bp_centraldata-title_key.
*  c_contact-address_type_2-postal-data-comm_type = i_person-central_data-common-data-bp_centraldata-comm_type.
* datax
  move-corresponding i_person-central_data-common-datax-bp_person
             to c_contact-address_type_2-postal-datax.      "#EC ENHOK
  c_contact-address_type_2-postal-datax-birth_name = i_person-central_data-common-datax-bp_person-birthname.
  c_contact-address_type_2-postal-datax-namctryiso = i_person-central_data-common-datax-bp_person-namcountryiso.
  c_contact-address_type_2-postal-datax-langu_p    = i_person-central_data-common-datax-bp_person-correspondlanguage.
  c_contact-address_type_2-postal-datax-langup_iso = i_person-central_data-common-datax-bp_person-correspondlanguageiso.
*  c_contact-address_type_2-postal-datax-fullname_x = i_person-central_data-common-datax-bp_person-fullname_man.

  c_contact-address_type_2-postal-datax-sort1_p   = i_person-central_data-common-datax-bp_centraldata-searchterm1.
  c_contact-address_type_2-postal-datax-sort2_p   = i_person-central_data-common-datax-bp_centraldata-searchterm2.
  c_contact-address_type_2-postal-datax-title_p   = i_person-central_data-common-datax-bp_centraldata-title_key.
*  c_contact-address_type_2-postal-datax-comm_type = i_person-central_data-common-datax-bp_centraldata-comm_type.
...
* read from DB
    ...
    if sy-subrc = 0.
      c_address_guid = ls_but020-address_guid.
    endif.
  endif.

  loop at i_relation-central_data-address-addresses into ls_address.
    if ls_address-data_key-guid = c_address_guid.
      c_contact-address_type_3-task = task_modify.
      ...
      move-corresponding ls_address-data-postal-data to c_contact-address_type_3-postal-data.
      c_contact-address_type_3-postal-data-floor_p    = ls_address-data-postal-data-floor.
      c_contact-address_type_3-postal-data-room_no_p  = ls_address-data-postal-data-room_no.
*     datax
      move-corresponding ls_address-data-postal-datax to c_contact-address_type_3-postal-datax.
      c_contact-address_type_3-postal-datax-floor_p    = ls_address-data-postal-datax-floor.
      c_contact-address_type_3-postal-datax-room_no_p  = ls_address-data-postal-datax-room_no.

      map_rel_version(
        exporting
          i_rel_version = ls_address-data-version
        importing
          e_cvi_version = c_contact-address_type_3-version
       ).
      ...
      map_bp_communication(
        ...
        importing
          e_cvi_communication = c_contact-address_type_3-communication
          ).
...
method map_bp_relation_business_hours.
  ...
  data:
    ...
    lv_cc_ab1        like c_contact-data-moab1,
    lv_cc_bi1        like c_contact-data-mobi1,   "#EC NEEDED
    lv_cc_ab2        like c_contact-data-moab2,
    lv_cc_bi2        like c_contact-data-mobi2.   "#EC NEEDED
  constants:
...
*
  loop at i_relation-central_data-business_hour-business_hours into ls_business_hour.
    ...
    IF ls_business_hour-DATA_KEY-SCHEDULE_TYPE = 'C'.  "business hours with schedule type C must be synchronised.
*   morning
    ...
    if sy-subrc = 0.
      do 7 times
        ...
        varying lv_cc_ab1  from c_contact-data-moab1 next c_contact-data-diab1
        varying lv_cc_bi1  from c_contact-data-mobi1 next c_contact-data-dibi1
        varying lv_cc_ab2  from c_contact-data-moab2 next c_contact-data-diab2
        varying lv_cc_bi2  from c_contact-data-mobi2 next c_contact-data-dibi2.
...
*   datax
    c_contact-datax-mobi1 =
    c_contact-datax-moab1 =
    c_contact-datax-diab1 =
    c_contact-datax-dibi1 =
    c_contact-datax-miab1 =
    c_contact-datax-mibi1 =
    c_contact-datax-doab1 =
    c_contact-datax-dobi1 =
    c_contact-datax-frab1 =
    c_contact-datax-frbi1 =
    c_contact-datax-saab1 =
    c_contact-datax-sabi1 =
    c_contact-datax-soab1 =
    c_contact-datax-sobi1 =

    c_contact-datax-moab2 =
    c_contact-datax-mobi2 =
    c_contact-datax-diab2 =
    c_contact-datax-dibi2 =
    c_contact-datax-miab2 =
    c_contact-datax-mibi2 =
    c_contact-datax-doab2 =
    c_contact-datax-dobi2 =
    c_contact-datax-frab2 =
    c_contact-datax-frbi2 =
    c_contact-datax-saab2 =
    c_contact-datax-sabi2 =
    c_contact-datax-soab2 =
    c_contact-datax-sobi2 = true.
    ELSE.
      CONTINUE.
    ENDIF.
  endloop.
...
method map_bp_relation_data.
  ...
  select single abtnr from cvic_cp1_link into c_contact-data-abtnr
         where  gp_abtnr = i_relation-central_data-contact-central_data-data-department."#EC *
  select single pafkt from cvic_cp2_link into c_contact-data-pafkt
         where  gp_pafkt = i_relation-central_data-contact-central_data-data-function."#EC *
  select single parvo from cvic_cp3_link into c_contact-data-parvo
         where  paauth   = i_relation-central_data-contact-central_data-data-authority."#EC *
  select single pavip from cvic_cp4_link into c_contact-data-pavip
         where  gp_pavip = i_relation-central_data-contact-central_data-data-vip."#EC *

  c_contact-data-parau   = i_relation-central_data-contact-central_data-data-comments.

  c_contact-datax-abtnr = i_relation-central_data-contact-central_data-datax-department.
  c_contact-datax-pafkt = i_relation-central_data-contact-central_data-datax-function.
  c_contact-datax-parvo = i_relation-central_data-contact-central_data-datax-authority.
  c_contact-datax-pavip = i_relation-central_data-contact-central_data-datax-vip.
  c_contact-datax-parau = i_relation-central_data-contact-central_data-datax-comments.
...
method map_bp_rel_business_address.
  ...
  if c_address_guid is initial AND i_partner-header-object_task <> 'I'.
* read from DB
  ...
  if sy-subrc = 0.
    if ls_address-data_key-guid <> c_address_guid.
      c_contact-address_type_1-task = task_modify.
      if ls_address-task = task_delete.
        c_contact-address_type_1-task = task_delete.
      endif.
      ...
      if sy-subrc = 0.
        move-corresponding:
          ls_partner_address-data-postal  to c_contact-address_type_1-postal."#EC ENHOK
      endif.

*     mapping type 3 to type 1
      move-corresponding:
       ls_address-data-postal  to c_contact-address_type_1-postal.
*       ls_address-data-version to c_contact-address_type_1-version."#EC ENHOK
      map_rel_version(
        exporting
          i_rel_version = ls_address-data-version
        importing
          e_cvi_version = c_contact-address_type_1-version
             ).
      ...
      map_bp_communication(
         exporting
           i_bp_communication  = ls_address-data-communication
         importing
           e_cvi_communication = c_contact-address_type_1-communication
           ).
...
*
      c_contact-address_type_1-postal-data-title = ls_person-central_data-common-data-bp_centraldata-title_key.
      c_contact-address_type_1-postal-data-sort1 = ls_person-central_data-common-data-bp_centraldata-searchterm1.
      c_contact-address_type_1-postal-data-sort2 = ls_person-central_data-common-data-bp_centraldata-searchterm2.
      ...
      if lv_person_name+40(40) is initial.
        c_contact-address_type_1-postal-data-name    = lv_person_name.
      else.
        c_contact-address_type_1-postal-data-name    = ls_person-central_data-common-data-bp_person-firstname.
        c_contact-address_type_1-postal-data-name_2  = ls_person-central_data-common-data-bp_person-lastname.
      endif.

      translate c_contact-address_type_1-postal-datax using ' X'.
...
method map_bp_rel_to_customer_contact.
...
method map_cc_business_address.
  ...
  check i_customer_contact-address_type_1 is not initial.
  ...
  ls_cc_deviant_adr = i_customer_contact-address_type_1.
  ls_cc_address     = i_customer_contact-address_type_3.
...
"    check i_customer_contact-address_type_1-task <> task_delete.
    if i_customer_contact-address_type_1 is not INITIAL
            and i_customer_contact-address_type_1-task <> task_delete.
    if i_customer_contact-address_type_1-task = task_update.
*   read address of contact
      get_cc_address(
        exporting
          i_organisation_guid   = c_partner-header-object_instance-bpartnerguid
          i_customer_contact_id = i_customer_contact-data_key-parnr
        importing
...
*         standard relationaddress is not standardaddress of the bp
          if i_customer_contact-address_type_1-task = task_delete
             OR i_customer_contact-address_type_1 is initial..
*           deletion
...
*           switch the standard address to organization standard address
            refresh c_relation-central_data-address-addresses.
...
*           update type 1 and type 3 address
            ...
            ls_org_address-data_key-guid = ls_but020-address_guid.
            move-corresponding:
            i_customer_contact-address_type_1-postal to ls_org_address-data-postal,"#EC ENHOK
            i_customer_contact-address_type_1-remark to ls_org_address-data-REMARK. "to map the remarks of alternate business address.

*             change type 3 address for the relationship
            ls_rel_address-task = task_update.
            ls_rel_address-data_key-guid = ls_but020-address_guid.
            move-corresponding:
              i_customer_contact-address_type_1-postal  to ls_rel_address-data-postal."#EC ENHOK
**********************************************************
            TRANSLATE ls_org_address-data-postal-datax USING ' X'.
            ls_org_address-data-postal-datax-STANDARDADDRESS =
                   ls_org_address-data-postal-datax-VALIDFROMDATE =
                   ls_org_address-data-postal-datax-VALIDTODATE = space.
            TRANSLATE ls_rel_address-data-postal-datax USING ' X'.
            ls_rel_address-data-postal-datax-STANDARDADDRESS = space.
**************************************************************************
            map_contact_version_to_rel(
              exporting
                i_contact_version = i_customer_contact-address_type_1-version
              importing
            ...
            map_cv_communication(
              exporting
                i_cvi_communication = i_customer_contact-address_type_1-communication
              importing
                e_bp_communication  = ls_rel_address-data-communication ).
            "ls_org_address-data-communication = ls_rel_address-data-communication.
...
* mapping to c_person-central_data-common
    if i_contact-address_type_3-postal-data-sex = lc_contact_male.
      c_person-central_data-common-data-bp_person-sex = lc_bp_male.
    elseif i_contact-address_type_3-postal-data-sex = lc_contact_female.
...
method map_cust_cont_to_bp_and_rel.
  ...
  if i_customer_contact-task <> task_insert and
     i_customer_contact-task <> task_current_state and
     i_customer_contact-task <> task_update and
     i_customer_contact-task <> task_delete and
     i_customer_contact-task <> task_modify.

    lv_msgvar1 = i_customer_contact-task.
    lv_msgvar2 = i_customer_contact-data_key-parnr.
...
* deletion of a customer contact causes a deletion of the relation
  if i_customer_contact-task = task_delete.
  ...
  map_cc_general_data(
    exporting
      i_contact  = i_customer_contact
    changing
      c_person   = c_person
      c_relation = c_relation
      ).

  map_cc_contact_address(
    exporting
      i_contact  = i_customer_contact
    changing
      c_partner  = c_partner
...
* Mapping of person data
  c_contact-address_type_1-postal-data-title = i_person-central_data-common-data-bp_centraldata-title_key.
  c_contact-address_type_1-postal-data-sort1 = i_person-central_data-common-data-bp_centraldata-searchterm1.
  c_contact-address_type_1-postal-data-sort2 = i_person-central_data-common-data-bp_centraldata-searchterm2.
  ...
  if lv_person_name+40(40) is initial.
    ...
    c_contact-address_type_1-postal-data-name    = i_person-central_data-common-data-bp_person-firstname.
    c_contact-address_type_1-postal-data-name_2  = i_person-central_data-common-data-bp_person-lastname.
  endif.
* X-Flags
  c_contact-address_type_1-postal-datax-title  = i_person-central_data-common-datax-bp_centraldata-title_key.
  c_contact-address_type_1-postal-datax-sort1  = i_person-central_data-common-datax-bp_centraldata-searchterm1.
  c_contact-address_type_1-postal-datax-sort2  = i_person-central_data-common-datax-bp_centraldata-searchterm2.

  c_contact-address_type_1-postal-datax-name   = i_person-central_data-common-datax-bp_person-firstname.
  c_contact-address_type_1-postal-datax-name_2 = i_person-central_data-common-datax-bp_person-lastname.


endmethod.


method map_person_to_customer_contact.
