*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_CVIV_CCID_LINK
*   generation date: 01.06.2005 at 16:22:31 by user C5039882
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_CVIV_CCID_LINK      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_CVIV_CCID_LINK'
         EXPORTING
              FCODE          = READ
...
EXTRACT = CVIV_CCID_LINK_EXTRACT
TOTAL = CVIV_CCID_LINK_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_CVIV_CCID_LINK'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_CVIV_CCID_LINK-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = CVIV_CCID_LINK_EXTRACT
TOTAL = CVIV_CCID_LINK_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_CVIV_CCID_LINK-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_CVIV_CCID_LINK'
...
TOTAL = CVIV_CCID_LINK_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_CVIV_CCID_LINK-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_CVIV_CCID_LINK-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_CVIV_CCID_LINK'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_CVIV_CCID_LINK-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = CVIV_CCID_LINK_EXTRACT
TOTAL = CVIV_CCID_LINK_TOTAL
