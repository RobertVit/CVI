*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_CVIV_CP3_LINK
*   generation date: 04.03.2005 at 11:50:04 by user C5034182
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_CVIV_CP3_LINK       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_CVIV_CP3_LINK'
         EXPORTING
              FCODE          = READ
...
EXTRACT = CVIV_CP3_LINK_EXTRACT
TOTAL = CVIV_CP3_LINK_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_CVIV_CP3_LINK'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_CVIV_CP3_LINK-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = CVIV_CP3_LINK_EXTRACT
TOTAL = CVIV_CP3_LINK_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_CVIV_CP3_LINK-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_CVIV_CP3_LINK'
...
TOTAL = CVIV_CP3_LINK_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_CVIV_CP3_LINK-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_CVIV_CP3_LINK-UPD_FLAG NE SPACE.
