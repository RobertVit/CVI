class CRM_IF_CL_CUSTOMIZING_CHECKS definition
  public
  final
  create public .
...
public section.
  ...
  constants GC_APPL_NAME_CUSTOMER type CVP_APPL_NAME value 'CRM_IF' ##NO_TEXT.
  constants GC_APPL_NAME_VENDOR type CVP_APPL_NAME value 'CRM_IF' ##NO_TEXT.
  constants GC_APPL_NAME_CONTACT_PERSON type CVP_APPL_NAME value 'CRM_IF' ##NO_TEXT.
...
CLASS CRM_IF_CL_CUSTOMIZING_CHECKS IMPLEMENTATION.
