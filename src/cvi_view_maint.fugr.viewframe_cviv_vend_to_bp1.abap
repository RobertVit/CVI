*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_CVIV_VEND_TO_BP1
*   generation date: 07.04.2005 at 10:51:31 by user C5034182
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_CVIV_VEND_TO_BP1    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_CVIV_VEND_TO_BP1'
         EXPORTING
              FCODE          = READ
...
EXTRACT = CVIV_VEND_TO_BP1_EXTRACT
TOTAL = CVIV_VEND_TO_BP1_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_CVIV_VEND_TO_BP1'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_CVIV_VEND_TO_BP1-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = CVIV_VEND_TO_BP1_EXTRACT
TOTAL = CVIV_VEND_TO_BP1_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_CVIV_VEND_TO_BP1-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_CVIV_VEND_TO_BP1'
...
TOTAL = CVIV_VEND_TO_BP1_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_CVIV_VEND_TO_BP1-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_CVIV_VEND_TO_BP1-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_CVIV_VEND_TO_BP1'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_CVIV_VEND_TO_BP1-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = CVIV_VEND_TO_BP1_EXTRACT
TOTAL = CVIV_VEND_TO_BP1_TOTAL
