*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_CVIV_MAP_CONTACT
*   generation date: 16.06.2005 at 13:31:36 by user C5028874
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_CVIV_MAP_CONTACT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_CVIV_MAP_CONTACT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = CVIV_MAP_CONTACT_EXTRACT
TOTAL = CVIV_MAP_CONTACT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_CVIV_MAP_CONTACT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_CVIV_MAP_CONTACT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = CVIV_MAP_CONTACT_EXTRACT
TOTAL = CVIV_MAP_CONTACT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_CVIV_MAP_CONTACT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_CVIV_MAP_CONTACT'
...
TOTAL = CVIV_MAP_CONTACT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_CVIV_MAP_CONTACT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_CVIV_MAP_CONTACT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_CVIV_MAP_CONTACT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_CVIV_MAP_CONTACT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = CVIV_MAP_CONTACT_EXTRACT
TOTAL = CVIV_MAP_CONTACT_TOTAL
