*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_CVIV_MARST_LINK
*   generation date: 04.03.2005 at 12:04:54 by user C5034182
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_CVIV_MARST_LINK     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_CVIV_MARST_LINK'
         EXPORTING
              FCODE          = READ
...
EXTRACT = CVIV_MARST_LINK_EXTRACT
TOTAL = CVIV_MARST_LINK_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_CVIV_MARST_LINK'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_CVIV_MARST_LINK-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = CVIV_MARST_LINK_EXTRACT
TOTAL = CVIV_MARST_LINK_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_CVIV_MARST_LINK-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_CVIV_MARST_LINK'
...
TOTAL = CVIV_MARST_LINK_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_CVIV_MARST_LINK-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_CVIV_MARST_LINK-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_CVIV_MARST_LINK'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_CVIV_MARST_LINK-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = CVIV_MARST_LINK_EXTRACT
TOTAL = CVIV_MARST_LINK_TOTAL
